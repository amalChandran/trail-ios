...
pairs=[
 ('spec/fixtures/contracts.json','Tests/TrailCoreTests/Fixtures/contracts.json'),
 ('samples/journeys.json','Examples/TrailPlayground/Resources/journeys.json'),
 ('samples/vehicles.json','Examples/TrailPlayground/Resources/vehicles.json'),
]
